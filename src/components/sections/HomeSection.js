      ...
      <div className="home__social-media u-mb-big u-mt-big">
        ...
        <br />
          ...
          <div className={classes.root}>
            <Grid container >
              <Grid item xs={3} >
                <a href="https://www.instagram.com/dscadgitm/?hl=en"><InstagramIcon fontSize='inherit' variant="primary"></InstagramIcon></a>
              </Grid>
              <Grid item xs={3}>
                <a href="https://www.linkedin.com/company/developer-students-club-adgitm"><LinkedInIcon fontSize='inherit' ></LinkedInIcon></a>
              </Grid>
              <Grid item xs={3}>
              <a href="https://github.com/Adgitmdsc"><GitHubIcon fontSize='inherit'></GitHubIcon></a>
              </Grid>
              <Grid item xs={3}>
                <a href="https://twitter.com/dscadgitm"><Twitter fontSize='inherit'></Twitter></a>
              </Grid>
            </Grid>
          </div>
